...
// This is a class in JavaScript that helps manage events. 
// It allows one part of a program (such as a function or object) 
// to tell another part of the program that something has happened.
class EventEmitter {
    constructor() {
        // creates empty list for info about events
        this.events = {};
    }
    ...
    // we call to emit when someone is click on the buttom
    emit(eventName, args = []) {
